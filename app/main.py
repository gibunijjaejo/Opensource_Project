...
from app.models import user, course, professor, activity, post, report, notice, portfolio as portfolio_models, contact as contact_model  # noqa: F401 — Base 테이블 등록용
